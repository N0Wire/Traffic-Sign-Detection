...
def collect(s_index, num_images, run_num):
	...
	np.save("Runs/overlap_"+str(run_num)+".npy", bos)
	np.save("Runs/time_"+str(run_num)+".npy", ts)
	f = open("Runs/boxes_"+str(run_num)+".dat", "wb")
...
#start_values = [[700, 10, 71],[710, 10, 72],[720, 10, 73],[730, 10, 74],[740, 10, 75]]			#15	#<- start here
