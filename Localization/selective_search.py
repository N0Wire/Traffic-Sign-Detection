...
This file holds the selective search algorithm
(slightly customized), which is used
to get region proposals.

takes image -> returns bounding boxes of possible objects
"""
###########################################
