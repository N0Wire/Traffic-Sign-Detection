...
This file contains the class Region, which
represents and holds informations of a region 
from the segmented image.
(Only ssed by the SelectiveSearch class) 
"""
###########################################
...
class Region:
	...
	def __init__(self, num):
		...
		self.neighbours = set() 			#neighbour regions
